...
public class  ElasticSearchRestClient implements ElasticSearchClient {
  ...
  public void execute() throws Exception {
    logger.info("****EkastucSearcgRestClient***");
  ...
  @Override
  public void addEvent(Event event, IndexNameBuilder indexNameBuilder, String realIndexType, long ttlMs, int count) throws Exception {
     addEvent(event, indexNameBuilder, realIndexType, ttlMs);
  }
}
