...
public class TimeBasedIndexNameBuilder implements
  ...
  public static final String DEFAULT_TIME_ZONE = "GMT+8";   //modify by liz 11.27
  ...
  public String getIndexName(Event event) {
    ...
    //logger.info(new Date(timestamp).toString() + " indexName" + gmtDateFormat.format(timestamp).toString());
  ...
  public void configure(Context context) {
    ...
    logger.info("[self] timezone:"+timeZoneString +" dateformat:"+dateFormatString);

    //gmtDateFormat = FastDateFormat.getInstance("yyyy-MM-dd HH:mm:ss",            TimeZone.getTimeZone(timeZoneString));
