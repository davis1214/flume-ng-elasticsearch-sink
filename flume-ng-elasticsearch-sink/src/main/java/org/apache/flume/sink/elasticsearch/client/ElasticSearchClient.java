...
public interface ElasticSearchClient extends Configurable {
  ...
  void execute(int count) throws Exception;

  void addEvent(Event event, IndexNameBuilder indexNameBuilder, String realIndexType, long ttlMs, int count) throws Exception;
}
