...
public class ElasticSearchClientFactory {
  ...
  public ElasticSearchClient getClient(String clientType, String[] hostNames,
      ...
      ElasticSearchIndexRequestBuilderFactory indexBuilder, int threadNum) throws NoSuchClientTypeException {
    if (clientType.equalsIgnoreCase(TransportClient) && serializer != null) {
      return new ElasticSearchTransportClient(hostNames, clusterName, serializer, threadNum);
