 ...
 *
 */
public class ElasticSearchObjectEventSerializer implements
    ElasticSearchEventSerializer {
  private static final Logger logger = LoggerFactory
          .getLogger(ElasticSearchObjectEventSerializer.class);
  @Override
  ...
  private void appendBody(XContentBuilder builder, Event event)
      throws IOException {
//    String fieldName = "logs";
//    byte[] body = event.getBody();
//    try {
//      XContentType contentType = XContentFactory.xContentType(body);
//      if (contentType == null) {
//        builder.field(fieldName, new String(body, charset));
//      } else {
//        XContentParser parser =
//                XContentFactory.xContent(contentType).createParser(body);
//        parser.nextToken();
...
//          ex.printStackTrace();
//          logger.error(ex.getMessage()+": "+ new String(body, charset));
//          builder.endObject();
//          builder.field(fieldName, new String(body, charset));
//        } finally {
//          if (parser != null) {
...
//      }
//    }catch (Exception e){
//      logger.error(new String(body, charset));
//      e.printStackTrace();
//    }
